...
alias proxy-git="git config --global http.proxy '$PROXY_SOCK_DSN ';git config --global https.proxy '$PROXY_SOCK_DSN'"
alias unproxy-git="git config --global --unset http.proxy; git config --global --unset https.proxy"
